<template>
  <svg :viewBox="viewbox" :style="svg" preserveAspectRatio="xMidYMid meet">
    <rect :style="rect.style" :clip-path="rect.clipPath" x="0" y="0" :width="width" :height="height" />
...
// https://raw.githubusercontent.com/LucasLeandro1204/vue-content-loading/master/src/components/VueContentLoading.vue
